...
> These are densities for class C1.
...
This is an application of t-SNE algorithm on the angles data. 
The data are well clustered and you can identify the steps.
